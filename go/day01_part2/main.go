...
func solve(elf_calories [][]int) int {
	...
	for _, calories := range elf_calories {
		...
		} else if total_elf_calories > max_calories_2 {
			max_calories_3 = max_calories_2
			max_calories_2 = total_elf_calories
		} else if total_elf_calories > max_calories_3 {
...
func main() {
	fmt.Println(solution("./example.txt")) // 45000
	fmt.Println(solution("./input.txt"))   // 199628
}
